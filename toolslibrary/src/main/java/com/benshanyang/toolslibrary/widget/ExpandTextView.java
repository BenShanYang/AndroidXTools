...
public class ExpandTextView extends AppCompatTextView {
    ...
    private void setCloseText() {
        ...
        if (appendShowAll) {
            ...
            ExpandTextView.super.setText(SPAN_CLOSE, TextView.BufferType.SPANNABLE);
            ...
            //文字没有超过指定行数
            ExpandTextView.super.setText(workingText, TextView.BufferType.NORMAL);
        }
    ...
    private void setExpandText(String text) {
        ...
        ExpandTextView.super.setText(SPAN_EXPAND, TextView.BufferType.SPANNABLE);
        setMovementMethod(LinkMovementMethod.getInstance());
        //注意，设置了ClickableSpan后，点击将会触发TextView在该区域的高亮效果，即一个背景变化，我们手动去除
        setHighlightColor(Color.TRANSPARENT);
    }
